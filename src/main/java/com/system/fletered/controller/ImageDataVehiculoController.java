...
@RestController
@RequestMapping("/imagenesVehiculo")

public class ImageDataVehiculoController {
    ...
    public ResponseEntity<?> downloadImage(@PathVariable Long idVehiculo){
        byte[] imageData= service.downloadImages(idVehiculo);
